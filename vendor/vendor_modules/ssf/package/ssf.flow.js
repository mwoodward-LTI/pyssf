    ...
    function format(fmt, /*:string|number*/ v, /*:any*/ o /*:?any*/) {
        ...
        switch (typeof fmt) {
            ...
            case "number":
                ...
                else {sfmt = (o.table != null ? (o.table /*:any*/) : table_fmt)[
                        fmt
                    ];}
                if (sfmt == null) {
